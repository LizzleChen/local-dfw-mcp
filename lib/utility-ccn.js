 ...
 * layer 230, from lib/sources.js) and added requireVerified guards on both
 * layers. lookupUtilityProviders / normalizeProvider shape unchanged.
...
export async function lookupUtilityProviders(lng, lat) {
  requireVerified(ARCGIS.waterCCN, "dfw_utility_providers (water CCN)");
  requireVerified(ARCGIS.sewerCCN, "dfw_utility_providers (sewer CCN)");
