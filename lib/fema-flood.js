 ...
 * Changes for local-dfw-mcp: none (FEMA NFHL + Census geocoder are national). Verbatim.
 * See LICENSE and NOTICE in the repository root.
 *
 * FEMA NFHL flood-zone client: geocode address (Census) -> spatial point query
 * against FEMA NFHL Layer 28 (Flood Hazard Zones).
 */
...
const FLOOD_TTL_MS = 24 * 60 * 60 * 1000;
