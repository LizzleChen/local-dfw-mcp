...
export const aboutTool = {
  ...
  async handler() {
    const text =
      ...
      `Denton 48121) or all of Texas / the U.S.\n` +
      ...
      `in v0.2.\n\n` +
      `## Disclaimers\n\n` +
      `- \`dfw_crime\` is **not a consumer report** and must not be used for ` +
      `tenant, employment, or other FCRA-regulated screening. Addresses are ` +
